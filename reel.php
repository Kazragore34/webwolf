...
<head>
    ...
    <title>Reel - Portafolio de Fotografía</title>
    ...
    <main>
        <section class="reel-page">
            <div class="reel-header">
                <h1>Reel Profesional</h1>
                <p>Descubre mi trabajo en movimiento</p>
            </div>
            ...
            <div class="reel-content">
                <div class="video-container">
                    <iframe 
                        width="100%" 
                        height="500" 
                        src="https://www.youtube.com/embed/6ZEI45q57VQ?autoplay=1&mute=0&quality=hd1080" 
                        frameborder="0" 
                ...
                <div class="reel-description">
                    <h2>Sobre este reel</h2>
                    <p>Este reel muestra una selección de mis trabajos más recientes, capturando la esencia de cada momento con mi visión artística única.</p>
                    <p>Si te gustó lo que viste, ¡no dudes en contactarme para colaborar en tu próximo proyecto!</p>
                </div>
            </div>
        </section>
    </main>
